...
def buffer_add_video_caption_meta(buffer: Gst.Buffer, caption_type: VideoCaptionType, data: Sequence[int]) -> VideoCaptionMeta: ...
def buffer_add_video_codec_alpha_meta(buffer: Gst.Buffer, alpha_buffer: Gst.Buffer) -> VideoCodecAlphaMeta: ...
def buffer_add_video_gl_texture_upload_meta(buffer: Gst.Buffer, texture_orientation: VideoGLTextureOrientation, n_textures: int, texture_type: VideoGLTextureType, upload: Callable[..., bool], user_data_copy: Callable[[None], None], user_data_free: Callable[[None], None], *user_data: Any) -> VideoGLTextureUploadMeta: ...
def buffer_add_video_meta(buffer: Gst.Buffer, flags: VideoFrameFlags, format: VideoFormat, width: int, height: int) -> VideoMeta: ...
def buffer_add_video_meta_full(buffer: Gst.Buffer, flags: VideoFrameFlags, format: VideoFormat, width: int, height: int, n_planes: int, offset: Sequence[int], stride: Sequence[int]) -> VideoMeta: ...
def buffer_add_video_overlay_composition_meta(buf: Gst.Buffer, comp: Optional[VideoOverlayComposition] = None) -> VideoOverlayCompositionMeta: ...
...
def buffer_add_video_sei_user_data_unregistered_meta(buffer: Gst.Buffer, uuid: int, data: int, size: int) -> VideoSEIUserDataUnregisteredMeta: ...
def buffer_add_video_time_code_meta(buffer: Gst.Buffer, tc: VideoTimeCode) -> Optional[VideoTimeCodeMeta]: ...
def buffer_add_video_time_code_meta_full(buffer: Gst.Buffer, fps_n: int, fps_d: int, latest_daily_jam: GLib.DateTime, flags: VideoTimeCodeFlags, hours: int, minutes: int, seconds: int, frames: int, field_count: int) -> Optional[VideoTimeCodeMeta]: ...
def buffer_get_video_meta(buffer: Gst.Buffer) -> Optional[VideoMeta]: ...
def buffer_get_video_meta_id(buffer: Gst.Buffer, id: int) -> Optional[VideoMeta]: ...
def buffer_get_video_region_of_interest_meta_id(buffer: Gst.Buffer, id: int) -> Optional[VideoRegionOfInterestMeta]: ...
...
def navigation_event_parse_command(event: Gst.Event) -> Tuple[bool, NavigationCommand]: ...
...
def navigation_query_parse_commands_nth(query: Gst.Query, nth: int) -> Tuple[bool, NavigationCommand]: ...
def navigation_query_set_angles(query: Gst.Query, cur_angle: int, n_angles: int) -> None: ...
def navigation_query_set_commandsv(query: Gst.Query, cmds: Sequence[NavigationCommand]) -> None: ...
def video_afd_meta_api_get_type() -> Type: ...
def video_afd_meta_get_info() -> Gst.MetaInfo: ...
def video_affine_transformation_meta_api_get_type() -> Type: ...
def video_affine_transformation_meta_get_info() -> Gst.MetaInfo: ...
def video_bar_meta_api_get_type() -> Type: ...
...
def video_caption_meta_api_get_type() -> Type: ...
...
def video_chroma_site_to_string(site: VideoChromaSite) -> Optional[str]: ...
def video_chroma_to_string(site: VideoChromaSite) -> str: ...
def video_codec_alpha_meta_api_get_type() -> Type: ...
def video_codec_alpha_meta_get_info() -> Gst.MetaInfo: ...
def video_color_matrix_from_iso(value: int) -> VideoColorMatrix: ...
def video_color_matrix_get_Kr_Kb(matrix: VideoColorMatrix) -> Tuple[bool, float, float]: ...
...
def video_color_range_offsets(range: VideoColorRange, info: VideoFormatInfo) -> Tuple[list[int], list[int]]: ...
...
def video_convert_sample(sample: Gst.Sample, to_caps: Gst.Caps, timeout: int) -> Gst.Sample: ...
def video_convert_sample_async(sample: Gst.Sample, to_caps: Gst.Caps, timeout: int, callback: Callable[..., None], *user_data: Any) -> None: ...
def video_crop_meta_api_get_type() -> Type: ...
...
def video_event_parse_downstream_force_key_unit(event: Gst.Event) -> Tuple[bool, int, int, int, bool, int]: ...
def video_event_parse_still_frame(event: Gst.Event) -> Tuple[bool, bool]: ...
def video_event_parse_upstream_force_key_unit(event: Gst.Event) -> Tuple[bool, int, bool, int]: ...
...
def video_frame_map(info: VideoInfo, buffer: Gst.Buffer, flags: Gst.MapFlags) -> Tuple[bool, VideoFrame]: ...
def video_frame_map_id(info: VideoInfo, buffer: Gst.Buffer, id: int, flags: Gst.MapFlags) -> Tuple[bool, VideoFrame]: ...
def video_gl_texture_upload_meta_api_get_type() -> Type: ...
...
def video_make_raw_caps(formats: Optional[Sequence[VideoFormat]] = None) -> Gst.Caps: ...
def video_make_raw_caps_with_features(formats: Optional[Sequence[VideoFormat]] = None, features: Optional[Gst.CapsFeatures] = None) -> Gst.Caps: ...
def video_mastering_display_info_from_string(mastering: str) -> Tuple[bool, VideoMasteringDisplayInfo]: ...
def video_meta_api_get_type() -> Type: ...
...
def video_multiview_mode_to_caps_string(mview_mode: VideoMultiviewMode) -> Optional[str]: ...
...
def video_orientation_from_tag(taglist: Gst.TagList) -> Tuple[bool, VideoOrientationMethod]: ...
def video_overlay_composition_meta_api_get_type() -> Type: ...
...
def video_overlay_set_property(object: GObject.Object, last_prop_id: int, property_id: int, value: Any) -> bool: ...
def video_region_of_interest_meta_api_get_type() -> Type: ...
def video_region_of_interest_meta_get_info() -> Gst.MetaInfo: ...
def video_sei_user_data_unregistered_meta_api_get_type() -> Type: ...
...
def video_time_code_meta_api_get_type() -> Type: ...
...
class ColorBalanceChannelClass(GObject.GPointer):
    ...
    value_changed: Callable[[ColorBalanceChannel, int], None] = ...
    _gst_reserved: list[None] = ...

class ColorBalanceInterface(GObject.GPointer):
    iface: GObject.TypeInterface = ...
    list_channels: Callable[[ColorBalance], list[ColorBalanceChannel]] = ...
    set_value: Callable[[ColorBalance, ColorBalanceChannel, int], None] = ...
    get_value: Callable[[ColorBalance, ColorBalanceChannel], int] = ...
    get_balance_type: Callable[[ColorBalance], ColorBalanceType] = ...
    value_changed: Callable[[ColorBalance, ColorBalanceChannel, int], None] = ...
    _gst_reserved: list[None] = ...
...
class Navigation(GObject.GInterface):
    ...
    @staticmethod
    def query_set_commandsv(query: Gst.Query, cmds: Sequence[NavigationCommand]) -> None: ...
...
class NavigationInterface(GObject.GPointer):
    iface: GObject.TypeInterface = ...
    send_event: Callable[[Navigation, Gst.Structure], None] = ...
    send_event_simple: Callable[[Navigation, Gst.Event], None] = ...
...
class VideoAggregatorClass(GObject.GPointer):
    ...
    update_caps: Callable[[VideoAggregator, Gst.Caps], Gst.Caps] = ...
    aggregate_frames: Callable[[VideoAggregator, Gst.Buffer], Gst.FlowReturn] = ...
    create_output_buffer: Callable[[VideoAggregator, Gst.Buffer], Gst.FlowReturn] = ...
    find_best_format: Callable[[VideoAggregator, Gst.Caps, VideoInfo], bool] = ...
    _gst_reserved: list[None] = ...
...
class VideoAggregatorConvertPadClass(GObject.GPointer):
    ...
    create_conversion_info: Callable[[VideoAggregatorConvertPad, VideoAggregator, VideoInfo], None] = ...
    _gst_reserved: list[None] = ...
...
class VideoAggregatorPadClass(GObject.GPointer):
    ...
    update_conversion_info: Callable[[VideoAggregatorPad], None] = ...
    prepare_frame: Callable[[VideoAggregatorPad, VideoAggregator, Gst.Buffer, VideoFrame], bool] = ...
    clean_frame: Callable[[VideoAggregatorPad, VideoAggregator, VideoFrame], None] = ...
    prepare_frame_start: Callable[[VideoAggregatorPad, VideoAggregator, Gst.Buffer, VideoFrame], None] = ...
    prepare_frame_finish: Callable[[VideoAggregatorPad, VideoAggregator, VideoFrame], None] = ...
    _gst_reserved: list[None] = ...
...
class VideoCodecFrame(GObject.GBoxed):
    ...
    events: list[None] = ...
    user_data: None = ...
    user_data_destroy_notify: Callable[[None], None] = ...
    def get_user_data(self) -> None: ...
    def ref(self) -> VideoCodecFrame: ...
    def set_user_data(self, user_data: None, notify: Callable[..., None], *user_data: Any) -> None: ...
    def unref(self) -> None: ...
...
class VideoDecoder(Gst.Element):
    ...
    def allocate_output_buffer(self) -> Optional[Gst.Buffer]: ...
    ...
    def get_frame(self, frame_number: int) -> Optional[VideoCodecFrame]: ...
    ...
    def get_oldest_frame(self) -> Optional[VideoCodecFrame]: ...
    def get_output_state(self) -> Optional[VideoCodecState]: ...
    ...
    def set_interlaced_output_state(self, fmt: VideoFormat, interlace_mode: VideoInterlaceMode, width: int, height: int, reference: Optional[VideoCodecState] = None) -> Optional[VideoCodecState]: ...
    ...
    def set_output_state(self, fmt: VideoFormat, width: int, height: int, reference: Optional[VideoCodecState] = None) -> Optional[VideoCodecState]: ...
...
class VideoDecoderClass(GObject.GPointer):
    ...
    open: Callable[[VideoDecoder], bool] = ...
    close: Callable[[VideoDecoder], bool] = ...
    start: Callable[[VideoDecoder], bool] = ...
    stop: Callable[[VideoDecoder], bool] = ...
    parse: Callable[[VideoDecoder, VideoCodecFrame, GstBase.Adapter, bool], Gst.FlowReturn] = ...
    set_format: Callable[[VideoDecoder, VideoCodecState], bool] = ...
    reset: Callable[[VideoDecoder, bool], bool] = ...
    finish: Callable[[VideoDecoder], Gst.FlowReturn] = ...
    handle_frame: Callable[[VideoDecoder, VideoCodecFrame], Gst.FlowReturn] = ...
    sink_event: Callable[[VideoDecoder, Gst.Event], bool] = ...
    src_event: Callable[[VideoDecoder, Gst.Event], bool] = ...
    negotiate: Callable[[VideoDecoder], bool] = ...
    decide_allocation: Callable[[VideoDecoder, Gst.Query], bool] = ...
    propose_allocation: Callable[[VideoDecoder, Gst.Query], bool] = ...
    flush: Callable[[VideoDecoder], bool] = ...
    sink_query: Callable[[VideoDecoder, Gst.Query], bool] = ...
    src_query: Callable[[VideoDecoder, Gst.Query], bool] = ...
    getcaps: Callable[[VideoDecoder, Gst.Caps], Gst.Caps] = ...
    drain: Callable[[VideoDecoder], Gst.FlowReturn] = ...
    transform_meta: Callable[[VideoDecoder, VideoCodecFrame, Gst.Meta], bool] = ...
    handle_missing_data: Callable[[VideoDecoder, int, int], bool] = ...
    padding: list[None] = ...
...
class VideoEncoder(Gst.Element, Gst.Preset):
    ...
    def set_output_state(self, caps: Gst.Caps, reference: Optional[VideoCodecState] = None) -> Optional[VideoCodecState]: ...
    def set_qos_enabled(self, enabled: bool) -> None: ...
    

class VideoEncoderClass(GObject.GPointer):
    element_class: Gst.ElementClass = ...
    open: Callable[[VideoEncoder], bool] = ...
    close: Callable[[VideoEncoder], bool] = ...
    start: Callable[[VideoEncoder], bool] = ...
    stop: Callable[[VideoEncoder], bool] = ...
    set_format: Callable[[VideoEncoder, VideoCodecState], bool] = ...
    handle_frame: Callable[[VideoEncoder, VideoCodecFrame], Gst.FlowReturn] = ...
    reset: Callable[[VideoEncoder, bool], bool] = ...
    finish: Callable[[VideoEncoder], Gst.FlowReturn] = ...
    pre_push: Callable[[VideoEncoder, VideoCodecFrame], Gst.FlowReturn] = ...
    getcaps: Callable[[VideoEncoder, Gst.Caps], Gst.Caps] = ...
    sink_event: Callable[[VideoEncoder, Gst.Event], bool] = ...
    src_event: Callable[[VideoEncoder, Gst.Event], bool] = ...
    negotiate: Callable[[VideoEncoder], bool] = ...
    decide_allocation: Callable[[VideoEncoder, Gst.Query], bool] = ...
    propose_allocation: Callable[[VideoEncoder, Gst.Query], bool] = ...
    flush: Callable[[VideoEncoder], bool] = ...
    sink_query: Callable[[VideoEncoder, Gst.Query], bool] = ...
    src_query: Callable[[VideoEncoder, Gst.Query], bool] = ...
    transform_meta: Callable[[VideoEncoder, VideoCodecFrame, Gst.Meta], bool] = ...
    _gst_reserved: list[None] = ...
...
class VideoFilterClass(GObject.GPointer):
    ...
    set_info: Callable[[VideoFilter, Gst.Caps, VideoInfo, Gst.Caps, VideoInfo], bool] = ...
    transform_frame: Callable[[VideoFilter, VideoFrame, VideoFrame], Gst.FlowReturn] = ...
    transform_frame_ip: Callable[[VideoFilter, VideoFrame], Gst.FlowReturn] = ...
    _gst_reserved: list[None] = ...
...
class VideoFormatInfo(GObject.GPointer):
    ...
    unpack_func: Callable[[VideoFormatInfo, VideoPackFlags, None, None, int, int, int, int], None] = ...
    pack_lines: int = ...
    pack_func: Callable[[VideoFormatInfo, VideoPackFlags, None, int, None, int, VideoChromaSite, int, int], None] = ...
...
class VideoInfo(GObject.GBoxed):
    ...
    @classmethod
    def new_from_caps(cls, caps: Gst.Caps) -> Optional[VideoInfo]: ...
...
class VideoMeta(GObject.GPointer):
    ...
    offset: list[int] = ...
    stride: list[int] = ...
    map: Callable[[VideoMeta, int, Gst.MapInfo, None, int, Gst.MapFlags], bool] = ...
    unmap: Callable[[VideoMeta, int, Gst.MapInfo], bool] = ...
    alignment: VideoAlignment = ...
    @staticmethod
    def get_info() -> Gst.MetaInfo: ...
    def get_plane_height(self) -> Tuple[bool, list[int]]: ...
    def get_plane_size(self) -> Tuple[bool, list[int]]: ...
    def map(self, plane: int, info: Gst.MapInfo, flags: Gst.MapFlags) -> Tuple[bool, None, int]: ...
...
class VideoOrientationInterface(GObject.GPointer):
    iface: GObject.TypeInterface = ...
    get_hflip: Callable[[VideoOrientation], Tuple[bool, bool]] = ...
    get_vflip: Callable[[VideoOrientation], Tuple[bool, bool]] = ...
    get_hcenter: Callable[[VideoOrientation], Tuple[bool, int]] = ...
    get_vcenter: Callable[[VideoOrientation], Tuple[bool, int]] = ...
    set_hflip: Callable[[VideoOrientation, bool], bool] = ...
    set_vflip: Callable[[VideoOrientation, bool], bool] = ...
    set_hcenter: Callable[[VideoOrientation, int], bool] = ...
    set_vcenter: Callable[[VideoOrientation, int], bool] = ...
...
class VideoOverlay(GObject.GInterface):
    ...
    @staticmethod
    def set_property(object: GObject.Object, last_prop_id: int, property_id: int, value: Any) -> bool: ...
...
class VideoOverlayComposition(GObject.GBoxed):
    ...
    def get_rectangle(self, n: int) -> Optional[VideoOverlayRectangle]: ...
    def get_seqnum(self) -> int: ...
    def make_writable(self) -> VideoOverlayComposition: ...
    def n_rectangles(self) -> int: ...
    @classmethod
    def new(cls, rectangle: Optional[VideoOverlayRectangle] = None) -> VideoOverlayComposition: ...
...
class VideoOverlayInterface(GObject.GPointer):
    iface: GObject.TypeInterface = ...
    expose: Callable[[VideoOverlay], None] = ...
    handle_events: Callable[[VideoOverlay, bool], None] = ...
    set_render_rectangle: Callable[[VideoOverlay, int, int, int, int], None] = ...
    set_window_handle: Callable[[VideoOverlay, int], None] = ...
...
class VideoRegionOfInterestMeta(GObject.GPointer):
    ...
    @staticmethod
    def get_info() -> Gst.MetaInfo: ...
    def get_param(self, name: str) -> Optional[Gst.Structure]: ...
...
class VideoSinkClass(GObject.GPointer):
    ...
    show_frame: Callable[[VideoSink, Gst.Buffer], Gst.FlowReturn] = ...
    set_info: Callable[[VideoSink, Gst.Caps, VideoInfo], bool] = ...
    _gst_reserved: list[None] = ...
...
class VideoTimeCode(GObject.GBoxed):
    ...
    def add_interval(self, tc_inter: VideoTimeCodeInterval) -> Optional[VideoTimeCode]: ...
    def clear(self) -> None: ...
    ...
    def init(self, fps_n: int, fps_d: int, latest_daily_jam: Optional[GLib.DateTime], flags: VideoTimeCodeFlags, hours: int, minutes: int, seconds: int, frames: int, field_count: int) -> None: ...
    ...
    @classmethod
    def new_from_date_time_full(cls, fps_n: int, fps_d: int, dt: GLib.DateTime, flags: VideoTimeCodeFlags, field_count: int) -> Optional[VideoTimeCode]: ...
    @classmethod
    def new_from_string(cls, tc_str: str) -> Optional[VideoTimeCode]: ...
    def nsec_since_daily_jam(self) -> int: ...
    def to_date_time(self) -> Optional[GLib.DateTime]: ...
    def to_string(self) -> str: ...
...
class VideoTimeCodeInterval(GObject.GBoxed):
    ...
    @classmethod
    def new_from_string(cls, tc_inter_str: str) -> Optional[VideoTimeCodeInterval]: ...
...
class VideoVBIEncoder(GObject.GBoxed):
    def add_ancillary(self, composite: bool, DID: int, SDID_block_number: int, data: Sequence[int]) -> bool: ...
    def copy(self) -> VideoVBIEncoder: ...
    def free(self) -> None: ...
    @classmethod
    def new(cls, format: VideoFormat, pixel_width: int) -> Optional[VideoVBIEncoder]: ...
...
class VideoVBIParser(GObject.GBoxed):
    ...
    @classmethod
    def new(cls, format: VideoFormat, pixel_width: int) -> Optional[VideoVBIParser]: ...
...
class VideoChromaSite(GObject.GFlags):
    ...
    @staticmethod
    def to_string(site: VideoChromaSite) -> Optional[str]: ...
...
class VideoMultiviewMode(GObject.GEnum):
    ...
    @staticmethod
    def to_caps_string(mview_mode: VideoMultiviewMode) -> Optional[str]: ...
